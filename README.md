...
| 10  | [Database Internals](./10-database-internals/)                           | LSM trees, write-ahead log, SSTables, compaction, crash recovery, MVCC, the page cache                | Mini key-value store with persistence and crash safety                    | 🚧     |
